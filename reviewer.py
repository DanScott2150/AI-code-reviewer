## Basic command line tool to have OpenAI perform a code review on a local file
## python reviewer.py [filename] [--model=openAI_Model]
## python reviewer.py samples/tree.py --model=gpt-4
...
Generate a code review for the file. Indicate what changes should bem ade to improve its style, performance, readability, and maintainability.
